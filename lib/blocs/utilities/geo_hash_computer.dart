...
///NOTICE: this code is taken from https://github.com/DarshanGowda0/GeoFlutterFire
///in particular this code can be found in
///https://github.com/DarshanGowda0/GeoFlutterFire/blob/master/lib/src/util.dart
///for reason of better understanding what the class is doing, I renamed the class
///Util as GeoHashComputer

class GeoHashComputer {
  ...
  ///this getter doesn't belong to the original code
  static List<double> get areaPrecisions => [
    PRECISION_KM_1,PRECISION_KM_2,PRECISION_KM_3,PRECISION_KM_4,PRECISION_KM_5,
    PRECISION_KM_6,PRECISION_KM_7,PRECISION_KM_8,PRECISION_KM_9
  ];
